...
class MainWindow(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        self.ui = uic.loadUi("main0.3_plotagem.ui", self) #Podemos importar nosso arquivo ui criado no QT Designer
    ...
    def stop_worker_1(self): #Ativamos a variável que pausa o recebimento de dados
        ...
        #Mudamos o estilo do botão para indicar que já plotamos os dados, mas agora o programa está pausado
        self.pushButton.setStyleSheet(
            "QPushButton"
            "{"
